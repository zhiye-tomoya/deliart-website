...
export default function Header() {
  return (
    <header className='fixed top-0 left-0 w-full bg-transparent z-50'>
      <div className='max-w-7xl mx-auto flex items-center justify-between py-4 md:py-[4rem] px-4 sm:px-6 border-b-1'>
        {/* Logo */}
        <Link href='/' className='text-white text-2xl font-light tracking-widest'>
          <Image src='/logo.svg' alt='DeliArt Logo' width={180} height={40} className='md:w-[120px] md:h-[40px]' />
        </Link>
